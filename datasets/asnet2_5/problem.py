...
class Problem:
    ...
    def __init__(self):
        ...
        self.B_mean = np.array([0.0,  0.005844572264972656, 0.0, 46.827197365928875])
        self.B_std = np.array([1.0,  0.00458764015054426, 1.0, 128.24172577578793])
...
# train model
# python main.py --data_dir=datasets/asnet5_5.11.32.37.44 --learning_rate=1e-3 --minibatch_size=500 --alpha=1e-2 --hidden_layers=2 --latent_dimension=20 --correction_updates=20 --track_validation=1000
